...
fetch(url, requestOptions)
  ...
  .then(async (result) => {
    ...
    var localprods = JSON.parse(result).Productos

    var localprods2=JSON.stringify(localprods)
    ...
    if (typeof localprods2 === 'undefined' || localprods2 === null)localprods2=''
 ...
 desc:localdes, loc:localloc, prods:localprods2})
